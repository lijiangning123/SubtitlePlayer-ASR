...
DP.DEFAULT_ASR_ENDPOINT = 'http://127.0.0.1:28778/api/transcribe';
...
DP.getAsrEndpoint = function getAsrEndpoint() {
  try {
    ...
    if (stored && !stored.includes(':8765/') && !stored.includes(':18765/') && !stored.includes(':28765/') && !stored.includes(':28768/')) {
      return stored;
    }
    if (stored) {
