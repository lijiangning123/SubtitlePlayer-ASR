...
DP.DEFAULT_ASR_ENDPOINT = 'http://127.0.0.1:28988/api/transcribe';
...
DP.getAsrEndpoint = function getAsrEndpoint() {
  try {
    ...
    if (stored && !stored.includes(':8765/') && !stored.includes(':18765/') && !stored.includes(':28765/') && !stored.includes(':28768/') && !stored.includes(':28778/') && !stored.includes(':28788/') && !stored.includes(':28888/')) {
      return stored;
    }
    if (stored) {
